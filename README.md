# IP_LAP：具有地标和外观先验的保持身份的说话人脸生成（CVPR 2023）

我们CVPR2023论文“**I**dentity-**P**reserving Talking Face Generation with **L**andmark and **A**ppearance **P**riors” 的PyTorch官方方案的升级。
...
## 测试
从[OneDrive](http://cloud.foxyear.cn/s/jMtW)下载预训练模型，并将其放置在 `checkpoints` 文件夹中。然后运行以下命令：
```
python inference.py
```
